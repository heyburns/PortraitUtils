...
from .bottom_banner_crop import (
    NODE_CLASS_MAPPINGS as BOTTOM_BANNER_CLASS_MAP,
    NODE_DISPLAY_NAME_MAPPINGS as BOTTOM_BANNER_DISPLAY_MAP,
)
from .solid_border_crop import (
    NODE_CLASS_MAPPINGS as SOLID_BORDER_CLASS_MAP,
    NODE_DISPLAY_NAME_MAPPINGS as SOLID_BORDER_DISPLAY_MAP,
)
...
NODE_CLASS_MAPPINGS.update(BOTTOM_BANNER_CLASS_MAP)
NODE_CLASS_MAPPINGS.update(SOLID_BORDER_CLASS_MAP)
...
NODE_DISPLAY_NAME_MAPPINGS.update(BOTTOM_BANNER_DISPLAY_MAP)
NODE_DISPLAY_NAME_MAPPINGS.update(SOLID_BORDER_DISPLAY_MAP)
