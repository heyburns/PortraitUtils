...
from .memory_reporter import (
    NODE_CLASS_MAPPINGS as MEMORY_REPORTER_CLASS_MAP,
    NODE_DISPLAY_NAME_MAPPINGS as MEMORY_REPORTER_DISPLAY_MAP,
)
...
NODE_CLASS_MAPPINGS.update(MEMORY_REPORTER_CLASS_MAP)
...
NODE_DISPLAY_NAME_MAPPINGS.update(MEMORY_REPORTER_DISPLAY_MAP)
